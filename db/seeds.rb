...
ALPHABET2 = "ABCDEFGHIJKLMNOPQRSTUVWXYZ abcdefghijklmnopqrstuvwxyz   123".split("")
GENDERS = ['male', 'female', 'm', 'f', 'woman', 'man', 'gender-binary', '']
...
20.times do
    ...
    Story.create(title: story_title, content: LOREM_IPSUM, user_experience: user_exp) 
end
